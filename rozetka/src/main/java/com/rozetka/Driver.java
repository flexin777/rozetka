...
public class Driver {
	...
	public static void main(String[] args) {
		...
		for (int i = 1; i <= 3; i++) {
			webElements.clear();
			// Click to next page. We pass first page
			if (i > 1) {
				driver.findElement(By.id("page" + i)).click();				
			}
			...
			for (WebElement webElement : webElements) {
				...
				String price = webElement
						.findElement(By.className("g-i-list-right-part"))
						.findElement(
								By.xpath("div[contains(@class,'g-i-list-price clearfix')]"))
				...
				try {
					note = webElement
							...
							.findElement(
									By.name("prices_active_element_original"))
							.getAttribute("class");
				...
				// Check if TOP
				if (note != null)
					if (note.equals("g-i-list-popularity"))
						topSmartphones.put(model, price);
